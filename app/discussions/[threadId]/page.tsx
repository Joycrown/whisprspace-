...
const loadThreadForSeo = async (threadId: string): Promise<ThreadSeoRow | null> => {
...
const getThreadForSeo = cache((threadId: string) =>
  unstable_cache(() => loadThreadForSeo(threadId), ['thread-seo', threadId], { revalidate: 120, tags: [`thread:${threadId}`] })()
)
