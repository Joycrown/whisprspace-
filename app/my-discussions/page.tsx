...
export default function MyThreadsPage() {
  ...
  const messageCountThreadKey = useMemo(
    () =>
      Array.from(
        new Set(
  ...
  useEffect(() => {
    const threadIds = messageCountThreadKey ? messageCountThreadKey.split(',') : [];
            ...
            <div className="bg-gray-800 border border-gray-700 rounded-xl p-8 md:p-12 text-center">
              ...
              <div className="relative group inline-block">
                {activeTab === 'created' && !canCreate ? (
                  ...
                  <Link
                    href={activeTab === 'created' ? '/discussions/create' : '/discussions'}
