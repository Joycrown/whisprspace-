...
// Node runtime — preserves Content-Length so WhatsApp renders the thumbnail.
    ...
    (
      ...
      >
        ...
        <div style={{
          ...
          borderRadius: '50%',
          background: 'linear-gradient(135deg, rgba(139,92,246,0.30) 0%, transparent 68%)',
          display: 'flex',
        }} />
        ...
        <div style={{
          ...
          borderRadius: '50%',
          background: 'linear-gradient(315deg, rgba(249,115,22,0.22) 0%, transparent 68%)',
          display: 'flex',
        }} />
        ...
        <div style={{
          ...
          <div style={{ display: 'flex', flexDirection: 'column' }}>
            ...
            <div style={{ fontSize: 72, fontWeight: 900, color: '#F2F2F6', lineHeight: 1.02, letterSpacing: '-2.5px', display: 'flex' }}>
              Speak freely.
            </div>
            <div style={{ fontSize: 72, fontWeight: 900, color: '#F2F2F6', lineHeight: 1.02, letterSpacing: '-2.5px', display: 'flex' }}>
              Stay
            </div>
            <div style={{ fontSize: 72, fontWeight: 900, color: 'rgba(242,242,246,0.22)', lineHeight: 1.02, letterSpacing: '-2.5px', display: 'flex' }}>
              anonymous.
            </div>
          </div>
