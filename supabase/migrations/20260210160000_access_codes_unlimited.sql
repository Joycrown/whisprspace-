-- ==========================================================
-- Keep partner access codes active for the thread lifespan
-- ==========================================================

ALTER TABLE public.thread_access_codes
...
BEGIN
  ...
  SELECT creator_id, is_premium, expires_at, deleted_at
  INTO v_creator_id, v_is_premium, v_expires_at, v_deleted_at
  FROM public.threads
