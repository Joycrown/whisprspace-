  ...
  return (
    <div className="space-y-6">
      ...
      <div className="flex items-center justify-between">
        ...
        {!isPremium && (
          <div className="bg-yellow-100 dark:bg-yellow-900/20 border border-yellow-500 rounded-lg px-4 py-2">
            ...
            return (
              <div key={index} className="flex-1 flex flex-col items-center gap-2">
                <div className="w-full relative group">
                  <div
                    className="w-full bg-gradient-to-t from-blue-500 to-purple-600 rounded-t-lg transition-all hover:from-blue-600 hover:to-purple-700 cursor-pointer"
      ...
      <div className="bg-blue-50 dark:bg-blue-900/20 rounded-xl p-6 border-2 border-blue-200 dark:border-blue-800">
        ...
        {earnings.pendingEarnings >= 10 && (
          <button 
            ...
            className="mt-4 w-full py-2 bg-blue-500 text-white font-medium rounded-lg hover:bg-blue-600 transition-colors"
          >
            Request Payout
          </button>
        )}
          ...
          <div className="relative w-full max-w-md max-h-[85vh] sm:max-h-[90vh] bg-white dark:bg-gray-900 rounded-2xl shadow-2xl p-4 sm:p-6 overflow-y-auto mb-4 sm:mb-0">
            ...
            <div className="flex gap-3">
              ...
              <button
                ...
                className="flex-1 py-3 px-4 bg-gradient-to-r from-green-500 to-emerald-600 text-white rounded-lg font-medium hover:from-green-600 hover:to-emerald-700 transition-all flex items-center justify-center gap-2 disabled:opacity-60"
              >
                <Download size={18} />
