...
export default function GroupInviteModal({ isOpen, onClose, groupId }: GroupInviteModalProps) {
  ...
  return (
    <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50 modal-safe-overlay">
      <div className="bg-white dark:bg-gray-800 rounded-xl shadow-xl max-w-2xl w-full modal-safe-panel overflow-y-auto">
        {/* Header */}
